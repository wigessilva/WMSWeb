...
from app.schemas.unidade_medida import UnidadeMedidaSchema, UnidadeMedidaCriar, UnidadeMedidaAtualizarDecimais
...
def atualizar_decimais(unidade_id: int, payload: UnidadeMedidaAtualizarDecimais, db: Session = Depends(get_db)):
    return UnidadeMedidaService.atualizar_decimais(db=db, unidade_id=unidade_id, decimais=payload.decimais)
