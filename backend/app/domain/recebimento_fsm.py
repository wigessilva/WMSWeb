...
class RecebimentoFSM(object):
    ...
    def __init__(self, recebimento_model):
        ...
        self.machine.add_transition(trigger='concluir_parcial', source=['EM_CONFERENCIA', 'AGUARDANDO_CONFERENCIA', 'EM_ANALISE'], dest='PARCIAL')
    ...
    def is_finalizado(self):
        return self.model.status == 'FINALIZADO'
